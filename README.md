...
A computer vision project based around **image classification** and deep learning.
...
Worked through a comprehensive machine learning and data science curriculum covering:
...
Worked through an end-to-end Generative AI development curriculum covering:
...
I'm particularly interested in projects that combine **AI + software engineering**.
...
Rather than building isolated ML notebooks, my goal is to turn models and LLMs into **usable applications with proper architectures, APIs, interfaces and deployment strategies**.
...
I believe the best way to learn engineering is to **build real systems**, encounter problems, understand why they happen, and improve the architecture along the way.
